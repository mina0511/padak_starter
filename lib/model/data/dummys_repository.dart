...
class DummysRepository {
  ...
  static List<MovieResponse> movieResponses = <MovieResponse>[
    MovieResponse(
        ...
        '신과함께-죄와벌',
        '판타지, 드라마',
        'https://upload.wikimedia.org/wikipedia/ko/1/18/%EC%8B%A0%EA%B3%BC%ED%95%A8%EA%BB%98_%EC%A3%84%EC%99%80_%EB%B2%8C.jpg',
        139,
    ...
    MovieResponse(
        ...
        '저스티스 리그',
        '액션,모험,판타지,SF',
        'https://upload2.inven.co.kr/upload/2017/07/24/bbs/i16536322327.jpg',
        120,
    ...
    MovieResponse(
        ...
        '토르:라그나로크',
        '액션, 모험, 판타지, SF',
        'https://cloudfront-ap-northeast-1.images.arcpublishing.com/chosun/DSC6YWYLN3WJDEEZRMJLO6HOUE.jpg',
        130,
    ...
    MovieResponse(
        ...
        '범죄도시',
        '액션',
        'https://lh3.googleusercontent.com/proxy/https://file.mk.co.kr/meet/neds/2017/09/image_readtop_2017_629546_15058102703035022.jpg',
        121,
    ...
    MovieResponse(
        ...
        '꾼',
        '범죄',
        'https://cloudfront-ap-northeast-1.images.arcpublishing.com/chosun/7GE5S5KRLIPR4KWWT67XIVQFRI.jpg',
        117,
    ...
    MovieResponse(
        ...
        '쥬만지: 새로운 세계',
        '액션, 모험',
        'https://img.hankyung.com/photo/201711/BF.15309261.1.jpg',
        118,
    ...
    MovieResponse(
        ...
        '뽀로로 공룡섬 대모험',
        '애니메이션',
        'https://mblogthumb-phinf.pstatic.net/MjAxNzExMTZfMzYg/MDAxNTEwODI1MDY2NDYx.vuI7SjAU-VnZffrKfmc-dH5GvXhr0BVSYTFm5MZemfkg.Xq_i-YOUGWAh-q7rzGpFYnVfeymPQxijZejyVgS4t8cg.JPEG.leonjuhee/%ED%81%AC%EA%B8%B0%EB%B3%80%ED%99%98_%EB%BD%80%EB%A1%9C%EB%A1%9C_%EA%B7%B9%EC%9E%A5%ED%8C%90_%EA%B3%B5%EB%A3%A1%EC%84%AC_%EB%8C%80%EB%AA%A8%ED%97%98_%EB%A9%94%EC%9D%B8%ED%8F%AC%EC%8A%A4%ED%84%B0_%EC%8A%A4%ED%81%AC%EB%A6%B0X%EB%B9%85%EB%A1%9C%EA%B3%A0_.jpg?type=w2',
        1179,
  ...
  static MoviesResponse moviesResponse = MoviesResponse(orderType: 0, movies: [
    ...
    Movie(
        ...
        'https://cloudfront-ap-northeast-1.images.arcpublishing.com/chosun/7GE5S5KRLIPR4KWWT67XIVQFRI.jpg',
        61.69),
    Movie('쥬만지: 새로운 세계', 3, 12, 7, '5a54c2f8e8a71d136fb537a7', '2018-01-03',
        'https://img.hankyung.com/photo/201711/BF.15309261.1.jpg', 14.93),
    Movie(
        '뽀로로 공룡섬 대모험',
        5,
        0,
